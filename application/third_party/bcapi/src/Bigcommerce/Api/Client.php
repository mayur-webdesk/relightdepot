...
class Client
{
    ...
    public static function getAllCustomfields($filter = array())
    {
        $filter = Filter::create($filter);
        return self::getCollection('/products/customfields' . $filter->toQuery() );
    }
    ...
    {
        return self::createResource('/products/' . $product_id . '/videos', $object);
    }
    ...
    public static function getOptionsCount()
    {
     ...
     public static function getCustomfieldCount()
    {
        return self::getCount('/products/customfields/count');
    }
     ...
     public static function getProductsSkusCount($id)
   {
    ...
    {
        return self::getResource('/customers/' . $id);
    }
