		...
		<div class="page-content">
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
						Magento to BigCommerce Customer Import
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li>
							<i class="fa fa-home"></i>
							<a href="<?php echo $this->config->site_url();?>admin/customer2">
			...
			<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-cogs"></i>Products Review List 
...
function sendRquest()
{
	...
	if(code){
		...
		$.ajax({
			url: '<?php echo $this->config->site_url();?>/admin/customer3/customerimport',
			data: {
				code: code,
				send:'yes'
			},
